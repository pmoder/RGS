...
def main():
    ...
    filename1 = "a350_DM10_H500_tb1/a350_DM10_H500_tb1.root"
    ...
    selection  = "(n_lep_signal == 1) && (n_lep == 1) && (Trigger_SingleLep == 1) && (lep1_pt >= 45000) && (n_jet >= 3) && (n_bjet >= 1) && (jet1_pt >= 50000) && (jet2_pt >= 50000) && (jet3_pt >= 20000) && (bjet1_pt >= 50000) && (dPhimin_4 >= 1.1) && (met >= 240000) && (mt >= 120000) && (mb1l >= 160000) && (mb1j1 <= 135000) && (amt2 >= 260000)"
