...
def main():
    ...
    selection  = "(n_lep_signal == 1) && (n_lep == 1) && (Trigger_SingleLep == 1) && (lep1_pt > 25000) && (n_jet >= 3) && (n_bjet >= 1) && (jet1_pt > 50000) && (jet2_pt > 50000) && (jet3_pt > 20000) && (bjet1_pt > 50000) && (met > 200000) && (mt > 100000) && (mb1l < 160000) && (dPhimin_4 > 1.1) && (PassTruthMetFilter == 1) && (mjj >= 65000) && (mjj <= 105000) && (amt2 >= 160000)"
