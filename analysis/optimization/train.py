...
def main():
    ...
    filename1 = "a350_DM10_H1200_tb1/a350_DM10_H1200_tb1.root"
    ...
    selection  = "(n_lep_signal == 1) && (n_lep == 1) && (Trigger_SingleLep == 1) && (lep1_pt > 25000) && (n_jet >= 3) && (n_bjet >= 1) && (jet1_pt > 50000) && (jet2_pt > 50000) && (jet3_pt > 20000) && (bjet1_pt > 50000) && (met > 234000) && (mt > 500000) && (mb1l > 160000) && (amt2 > 215000) && (mt2w > 0) && (mb1j1 < 132000)"
