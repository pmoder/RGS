...
#	if s == 0:
#	    Z = 0.0
#	elif (sqrt(cuts.sqrdWeight_signal)/s + 0.2*s > 0.5):
#	    Z = 0.0
	ntuple.read(row)
#	if ntuple("mt") > 400000: Z = -20.0
#	if ntuple("met") > 350000: Z = -20.0
#	if ntuple("amt2") > 300000: Z = -20.0
	if ntuple("dPhiBJet1Met") > 1.6: Z = -20.0
	if Z > bestZ:
	    bestZ = Z
	    bestrow = row
	    bestsigma = sigma
